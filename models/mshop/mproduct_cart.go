...
// 清理用户购物车
func (m *ShopModel) DelProductCartByIds(cartIds []int, userId string) (int64, error) {
	return m.Engine.Where("user_id=?", userId).In("id", cartIds).Delete(&models.ProductCart{})
}
