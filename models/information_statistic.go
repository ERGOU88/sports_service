...
type InformationStatistic struct {
	NewsId      int64 `json:"news_id" xorm:"not null pk comment('资讯id') BIGINT(20)"`
	...
	HeatNum     int   `json:"heat_num" xorm:"not null default 0 comment('热度 点赞数+ 浏览数 + 评论数') INT(11)"`
}
