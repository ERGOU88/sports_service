...
type VenueInfo struct {
	...
	VenueImages   string `json:"venue_images" xorm:"not null default '' comment('场馆图片 多张逗号分隔') VARCHAR(300)"`
	...
	Status        int    `json:"status" xorm:"not null default 0 comment('0 正常营业 1 暂停营业') TINYINT(1)"`
