...
type SystemMessage struct {
	...
	TaskId        string `json:"task_id" xorm:"not null default '' comment('友盟任务id') VARCHAR(256)"`
	UmengPlatform int    `json:"umeng_platform" xorm:"not null default 0 comment('1 android 2 ios') TINYINT(1)"`
}
