...
type Orders struct {
	...
	PayStatus        int    `json:"pay_status" xorm:"not null default 0 comment('支付状态 0 未付款 1 已付款') index TINYINT(2)"`
	DeliveryStatus   int    `json:"delivery_status" xorm:"not null default 0 comment('配送状态 0 未配送 1 已配送') TINYINT(2)"`
