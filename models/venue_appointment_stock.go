...
type VenueAppointmentStock struct {
	...
	TimeNode        string `json:"time_node" xorm:"not null pk default '' comment('时间节点 例如 10:00-12:00') VARCHAR(128)"`
	...
	RelatedId       int64  `json:"related_id" xorm:"not null comment('场馆id/私教id/课程id') BIGINT(20)"`
}
